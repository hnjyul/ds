...
export const mobileNav: SurfaceNav = [
  ...
  },
  {
    ...
    items: [
      ...
      { slug: "bottom-cta", label: "BottomCTA", description: "화면 하단에 고정되어 다음 단계로 이동을 유도하는 행동 영역입니다.", treatment: "standard" },
      { slug: "dialog", label: "Dialog", description: "중요한 결정 전에 사용자의 주의를 집중시키는 모달 레이어입니다.", treatment: "standard" },
      { slug: "toast", label: "Toast · Snackbar", description: "화면 흐름을 막지 않고 짧은 상태 메시지를 잠시 보여줍니다.", treatment: "standard" },
      { slug: "list-row", label: "ListRow", description: "제목, 설명, 우측 요소를 일관된 구조로 배열하는 목록 행입니다.", treatment: "standard" },
