...
export default function PcButtonDetail() {
  return (
    <DetailDocTemplate
      eyebrow={formatEyebrow("pc", "components")}
      category="Actions"
      title="Button"
      description="화면에서 가장 중요한 행동을 실행하는 기본 조작 요소입니다. 모바일과 동일한 토큰을 공유합니다."
      version="2.1.0"
      ...
      tokenRows={[
        ...
        { label: "모서리 반경(PC)", token: "--component-button-radius" },
      ]}
      guidelines={[
        {
          tone: "do",
